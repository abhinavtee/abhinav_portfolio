...
import { FaDownload, FaEnvelope } from 'react-icons/fa'; // Download and Email Icons
import { SiLinkedin, SiGithub } from 'react-icons/si'; // LinkedIn and GitHub Icons
export const Contact = () => {
    ...
    return (
        ...
        <section id="contact" className="min-h-screen flex flex-col items-center justify-center py-20">
            ...
            <RevealOnScroll>
                <div className="px-4 w-150">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-blue-500 text-white py-3 px-6 rounded  font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,4)]"> Send Message</button>
                    </form>
                </div>
            </RevealOnScroll>
            ...
            {/* Reach Me Section */}
            <div className="text-center mt-12 py-4 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-xl shadow-lg max-w-4xl mx-auto px-20 hover:-translate-y-0.5  hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition">
