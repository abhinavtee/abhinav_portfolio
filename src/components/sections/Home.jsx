        ...
        <section id="home" className="min-h-screen flex items-center justify-center relative">
            ...
            <RevealOnScroll>
                ...
                <div className=" text-center z-10 p-4">
                    <h1 className="text-5xl md:text-7xl font-bold mb-6  bg-gradient-to-r from-blue-500 to-cyan-400 leading-right bg-clip-text text-transparent">Hi, I am Abhinav Tripathi</h1>
                    ...
                    <div className="flex justify-center space-x-4">
                        ...
                        <a href="/Abhinav_Tripathi_FullStack_Web_Developer.pdf" download className="bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]">
                            Download CV
                        </a>
